...
namespace Account
{
    public class GanjilGenap
    {
        ...
        public static void ProgramEvenOdd()
        {           
            ...
            while (!exit)                               // membuat loop selama nilai exit bukan true atau false
            {
                ...
                MenuGanjilGenap();
                Console.Write("Pilihan Menu : ");                         // menampilkan output string        
                ...
                try
                {
                    ...
                    switch (pilihan)
                    {
                        ...
                        case 3:
                            ...
                            exit = true;
                            Program.Main(new string[] {"0"}); // mema
                            /*Menu menu = new Menu();
                            menu.Run();*/
                            break;                                                   // untuk mengehentikan eksekusi 
                        /*default:
                            ProgramEvenOdd();// jika pilihan tidak sesuai maka tidak terjadi apa-apa namun dalam case ini akan kemabali loop
                            break;                                                   // untuk mengehentikan eksekusi */
                    }
                } 
                catch (Exception ex3)
